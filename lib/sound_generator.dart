...
class SoundGenerator {
  ...
  static void setAutoUpdateOneCycleSample(bool autoUpdateOneCycleSample) async {
    await _channel.invokeMethod(
      ...
      <String, dynamic>{"autoUpdateOneCycleSample": autoUpdateOneCycleSample},
    );
  }

  /// Set Frequency
  static void setFrequency(double frequency) async {
    await _channel.invokeMethod("setFrequency", <String, dynamic>{
      "frequency": frequency,
    });
  }
  ...
  static void setBalance(double balance) async {
    await _channel.invokeMethod("setBalance", <String, dynamic>{
      "balance": balance,
    });
  }
  ...
  static void setCleanStart(bool cleanStart) async {
    await _channel.invokeMethod("setCleanStart", <String, dynamic>{
